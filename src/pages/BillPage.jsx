...
const BillPage = () => {
    ...
    const { data, loading } = useFetchData(`https://raw.githubusercontent.com/hyunminkim93/music-best/main/billboard/billboard100_${formattedDate}.json`)
